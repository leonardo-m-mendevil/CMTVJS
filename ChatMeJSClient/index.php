...
if (isset($DEVICE_TYPE) and $DEVICE_TYPE=="MOBILE") {
  $location='mobile.php?pre='.$pre.'&topic='.$topic.'&source='$source;
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<head>
    	...
    	<link href="css/nok.css" rel="stylesheet" type="text/css" />
		</head>
	<body>
   	<div align="left">
   	  <div class="copy1"></div>
       	  <span class="copy1">Topic: </span>
    ...
    <input type="button" class="Start" onclick="sessionVars();" value="Start Session"  />
	  ...
	  <script language="javascript" type="text/javascript">
			...
			function setInviteField(){
       	  ...
       	  <div id="output"></div>
		  <textarea name="send"  class="send" id="send" rows="2" cols="25">start chat...</textarea>
   	  <div class="clearLog"></div>
  <span class="smessage">
  <input name="submit" type="image" src="img/SEND.png" class="copy2" id="submit" onclick="sendMessage();" value="send message" />
</span><br />
